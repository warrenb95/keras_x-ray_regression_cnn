...
if __name__ == "__main__":
    ...
    if int(usr_in) == 1:
        ...
        classification_train_gen, classification_valid_gen = trainer.load_classification_data()
        model = trainer.train_new_classification(classification_train_gen, classification_valid_gen)
